...
class Terminal:
    def __init__(self, win):
        ...
        self.unknown = self.myfont.render(
            'Unknown command - type "help" for help', True, (200, 200, 200)
        )

    def draw(self, win):
        pygame.draw.rect(
            win.display, (25, 25, 25), (win.WIN_X, 0, 600, win.WIN_Y)
        )  # Big rect
        pygame.draw.rect(
            win.display, (40, 40, 40), (win.WIN_X, win.WIN_Y - 60, 600, 60)
        )  # Input-background
        pygame.draw.rect(
            win.display,
            (120, 120, 120) if self.active else (60, 60, 60),
            (win.WIN_X, win.WIN_Y - 60, 600, 60),
            5,
        )  # Input-Border
